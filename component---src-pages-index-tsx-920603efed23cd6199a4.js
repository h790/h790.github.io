...
`;function ar(e,t){return n=>n?e():t()}function or(e){return ar(e,(()=>null))}function ir(e){return or((()=>({opacity:0})))(e)}const sr=e=>{const{cascade:t=!1,damping:n=.5,delay:a=0,duration:o=1e3,fraction:i=0,keyframes:s=Xn,triggerOnce:c=!1,className:l,style:u,childClassName:g,childStyle:d,children:f,onVisibilityChange:p}=e,m=(0,r.useMemo)((()=>function({duration:e=1e3,delay:t=0,timingFunction:n="ease",keyframes:r=Xn,iterationCount:a=1}){return Cn`
  ...
  `}({keyframes:s,duration:o})),[o,s]);return function(e){return null==e}(f)?null:"string"==typeof(y=f)||"number"==typeof y||"boolean"==typeof y?An(lr,{...e,animationStyles:m,children:String(f)}):(0,Fn.isFragment)(f)?An(ur,{...e,animationStyles:m}):An(xn,{children:r.Children.map(f,((s,f)=>{if(!(0,r.isValidElement)(s))return null;const y=a+(t?f*o*n:0);switch(s.type){case"ol":case"ul":return An(Tn,{children:({cx:t})=>An(s.type,{...s.props,className:t(l,s.props.className),style:Object.assign({},u,s.props.style),children:An(sr,{...e,children:s.props.children})})});case"li":return An(Vn,{threshold:i,triggerOnce:c,onChange:p,children:({inView:e,ref:t})=>An(Tn,{children:({cx:n})=>An(s.type,{...s.props,ref:t,className:n(g,s.props.className),css:or((()=>m))(e),style:Object.assign({},d,s.props.style,ir(!e),{animationDelay:y+"ms"})})})});default:return An(Vn,{threshold:i,triggerOnce:c,onChange:p,children:({inView:e,ref:t})=>An("div",{ref:t,className:l,css:or((()=>m))(e),style:Object.assign({},u,ir(!e),{animationDelay:y+"ms"}),children:An(Tn,{children:({cx:e})=>An(s.type,{...s.props,className:e(g,s.props.className),style:Object.assign({},d,s.props.style)})})})})}}))});var y},cr={display:"inline-block",whiteSpace:"pre"},lr=e=>{const{animationStyles:t,cascade:n=!1,damping:r=.5,delay:a=0,duration:o=1e3,fraction:i=0,triggerOnce:s=!1,className:c,style:l,children:u,onVisibilityChange:g}=e,{ref:d,inView:f}=Hn({triggerOnce:s,threshold:i,onChange:g});return ar((()=>An("div",{ref:d,className:c,style:Object.assign({},l,cr),children:u.split("").map(((e,n)=>An("span",{css:or((()=>t))(f),style:{animationDelay:a+n*o*r+"ms"},children:e},n)))})),(()=>An(ur,{...e,children:u})))(n)},ur=e=>{const{animationStyles:t,fraction:n=0,triggerOnce:r=!1,className:a,style:o,children:i,onVisibilityChange:s}=e,{ref:c,inView:l}=Hn({triggerOnce:r,threshold:n,onChange:s});return An("div",{ref:c,className:a,css:or((()=>t))(l),style:Object.assign({},o,ir(!l)),children:i})};const gr=On`
  from,
  20%,
  40%,
  60%,
...
`;const Nr=e=>{const{direction:t,reverse:n=!1,...a}=e,o=(0,r.useMemo)((()=>function(e,t){switch(t){case"down":return e?hr:dr;case"left":return e?Mr:fr;case"right":return e?vr:pr;case"up":return e?jr:mr;default:return e?yr:gr}}(n,t)),[t,n]);return An(sr,{keyframes:o,...a})},br=On`
  from {
    opacity: 1;
  }
...
`;const zr=e=>{const{big:t=!1,direction:n,reverse:a=!1,...o}=e,i=(0,r.useMemo)((()=>function(e,t,n){switch(n){case"bottom-left":return t?wr:Wn;case"bottom-right":return t?Ir:Jn;case"down":return e?t?Lr:Kn:t?Dr:Zn;case"left":return e?t?Ar:qn:t?xr:Xn;case"right":return e?t?Or:$n:t?Cr:_n;case"top-left":return t?Sr:er;case"top-right":return t?Er:tr;case"up":return e?t?kr:rr:t?Tr:nr;default:return t?br:Gn}}(t,a,n)),[t,n,a]);return An(sr,{keyframes:i,...o})};On`
  from {
...
`;const Fr=e=>{const{direction:t,reverse:n=!1,...a}=e,o=(0,r.useMemo)((()=>function(e,t){switch(t){case"down":return e?Br:Qr;case"right":return e?Vr:Ur;case"up":return e?Hr:Yr;default:return e?Rr:Pr}}(n,t)),[t,n]);return An(sr,{keyframes:o,...a})};On`
  from {
    opacity: 0;
    transform: scale3d(0.3, 0.3, 0.3);
  }
